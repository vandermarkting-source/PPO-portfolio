...
import { MessageSquare, Star, Users, Heart, ChevronLeft, ChevronRight, Quote, FileSpreadsheet, Download } from 'lucide-react';
...
const FeedbackPage = () => {
  ...
  // Wordcloud woorden (meest genoemd)
  const WORDS = [
    { text: 'doelgericht', size: 'text-2xl font-bold' },
    { text: 'verantwoordelijk', size: 'text-xl font-semibold' },
    { text: 'sportief', size: 'text-lg' },
    { text: 'enthousiast', size: 'text-xl font-semibold' },
    { text: 'positief', size: 'text-lg' },
    { text: 'betrouwbaar', size: 'text-2xl font-bold' },
    { text: 'taalvaardig', size: 'text-base' },
    { text: 'humor', size: 'text-lg' },
    { text: 'strategisch', size: 'text-base' }
  ];
